import { navLinks } from '@/constatns/Constants'
...
const MobileNav = ({ closeNav, nav }: Props) => {
  ...
  return (
    <div className={`transform ${responsiveNav} transition-all duration-500 fixed top-0 left-0 z-[200] h-[100vh] right-0 bottom-0 bg-[#f0fb7b]`}>
      {/*logo */}
      <div>
