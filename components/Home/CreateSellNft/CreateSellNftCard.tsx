...
const CreateSellNftCard = ({image,title}:Props) => {
  return (
      <div>
          ...
          <p className="text-sm text-black text-center text-opacity-60">Lorem ipsum dolor sit Lorem ipsum dolor sit amet consectetur, adipisicing elit. Corrupti, doloribus.</p>
    </div>
  )
}
